...
-- Устанавливаем везде блочный курсор
...
require('lazy').setup({
  'tpope/vim-sleuth', -- Detect tabstop and shiftwidth automatically
  {
    ...
    event = 'InsertEnter',
    opts = {
      check_ts = true, -- использовать Tree‑sitter для контекста
      enable_afterquote = true, -- не добавлять лишнюю кавычку
    },
  },
  {
  ...
  },
  {
    ...
    priority = 1000, -- чтобы применялась до других плагинов
    config = function()
      require('gruvbox').setup {
        terminal_colors = true, -- включает цвета в терминале
        contrast = '', -- может быть "hard", "soft" или пустым
        overrides = {}, -- свои цвета, если нужно
      }
